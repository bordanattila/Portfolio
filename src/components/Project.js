...
function Project(props) {
    ...
    return (
                <div className="project-card gradient-border">
                    ...
                    {props.project.deployed === "Not deployed" ? <span className="footerIcon">Not deployed</span> : <a href={props.project.deployed} target={"_blank"} className="footerIcon"><i className="fa-solid fa-arrow-up-right-from-square"></i></a>}
